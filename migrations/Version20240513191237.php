 ...
 */
final class Version20240513191237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_674C1E298E54FB25 ON livraison_history');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_674C1E298E54FB25 ON livraison_history (livraison_id)');
    }
}
